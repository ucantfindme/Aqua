...
cursor.execute(table)
# Queries to INSERT records.
cursor.execute('''INSERT INTO TEACHER VALUES ('CSED', 'NSPKrishna', 'NaSaPaKri,Nobrain,AJKrishna,PKrishna,Varun36,Deepti,Bhargav11,Harthik07,Sanketh12', 'CSE', 'CS,DS,SE,SNA,DL,PPL')''')
# Display data inserted
"""print("Data Inserted in the table: ")
data=cursor.execute('''SELECT * FROM PERSON''')
for row in data:
